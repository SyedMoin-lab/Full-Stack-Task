    ...
    <main className="flex flex-col min-h-[100dvh] space-y-10">
      ...
      <section id="skills">
        <div className="flex min-h-0 flex-col gap-y-3">
          <BlurFade delay={BLUR_FADE_DELAY * 9}>
            <HyperText className="text-xl font-bold" text="Skills" duration={600}></HyperText>
          </BlurFade>
      ...
      <section id="work">
        <div className="flex min-h-0 flex-col gap-y-3">
          ...
          <HyperText className="text-xl font-bold" text="Work Experience" duration={600}></HyperText>
          </BlurFade>
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 13}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Each piece allowed me to explore and articulate my understanding of complex topics, fostering a deeper appreciation for the intersection of theory & practice.
                </p>
              </div>
            </div>
          </BlurFade>
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                ...
                and I&apos;ll reply when I can—assuming it&apos;s not something I didn&apos;t ask for
              </p>
            </div>
          </BlurFade>
        </div>
